...
def import_object(object_path: str, location: Tuple[float, float, float], orientation: Tuple[float, float, float]) -> bpy.types.Object:
    """
    Imports an .fbx or .obj object into Blender and positions/orients it according to the given parameters.
...
if __name__ == '__main__':
    dog1 = import_object("/home/khai/Downloads/lion.fbx", location=(4, 9, 2), orientation=(0, 0, 0))
    dog2 = import_object("/home/khai/Downloads/lion.fbx", location=(0, 0, 5), orientation=(0, 0, 0))
    dog3 = import_object("/home/khai/Downloads/lion.fbx", location=(5, 3, 2), orientation=(0, 0, 0))
    assets = {'dog1': dog1, 'dog2': dog2, 'dog3': dog3}

    # ---------------------------------------------------------------------------
    # parallelism_score bi loi
    constraints = [(alignment_score, {'assets': [assets['dog1'], assets['dog2']], 'axis': 'x'}), 
                   (perpendicularity_score, {'object1': assets['dog1'], 'object2': assets['dog2']})]
    # ----------------------------------------------------------------------------
